...
pub fn Fullscreen(
    ...
    queue: Signal<Vec<crate::reader::Track>>,
    ...
    let get_track_cover = |track: &crate::reader::Track| -> Option<String> {
        let lib = library.read();
        lib.albums
            .iter()
            .find(|a| a.id == track.album_id)
            .and_then(|album| crate::utils::format_artwork_url(album.cover_path.as_ref()))
    };
